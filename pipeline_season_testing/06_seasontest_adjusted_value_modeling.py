...
df.to_csv('data/06_seasontest_adjusted_qb_values.csv')
...
df.to_csv('data/06_seasontest_adjusted_rushing_values.csv')
...
df.to_csv('data/06_seasontest_adjusted_pass_defense_values.csv')
...
df.to_csv('data/06_seasontest_adjusted_rush_defense_values.csv')
