...
nfl_df = nfl.import_pbp_data([current_season-1, current_season])

# Add column detailing if there was a qb designed run

rosters = nfl.import_rosters([current_season-1, current_season])
...
final_nfl_df_fixed_qb.to_csv('data/01_seasontest_nfl_data_transformation_results.csv')
...
schedule_df.to_csv('data/seasontest_schedule_df.csv')
