...
qb_lookup = pd.read_csv('data/03_team_primary_qb_lookup_table.csv')
...
passing_def_to_save.to_csv('data/04_initial_pass_defense_values.csv')
...
rush_def_to_save.to_csv('data/04_initial_rush_defense_values.csv')
...
st_to_save.to_csv('data/04_initial_st_values.csv')
...
extra_to_save.to_csv('data/04_initial_extra_values.csv')
